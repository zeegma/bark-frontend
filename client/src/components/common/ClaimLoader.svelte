...
>
  <!-- Header Skeleton -->
  <div
    class="flex border h-[48px] rounded-tl-2xl rounded-tr-2xl border-stone-300 bg-gray-200"
  >
    <div
      class="flex h-full items-center gap-3 px-6 border-r-1 border-stone-300"
    >
      <div class="w-6 h-6 bg-gray-300 rounded"></div>
      <div class="w-16 h-6 bg-gray-300 rounded"></div>
    </div>
    <div class="flex flex-grow justify-center items-center lg:pr-32">
      <div class="w-24 sm:w-48 h-6 bg-gray-300 rounded"></div>
    </div>
  </div>
